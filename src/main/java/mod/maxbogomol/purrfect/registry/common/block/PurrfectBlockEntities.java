...
public class PurrfectBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<FlagBlockEntity>> FLAG = BLOCK_ENTITIES.register("flag", () -> BlockEntityType.Builder.of(FlagBlockEntity::new,
                    ...
                    PurrfectBlocks.WIZARDS_REBORN_FLAG.get(), PurrfectBlocks.FLUFFY_FUR_FLAG.get(), PurrfectBlocks.SILLY_ODDITIES_FLAG.get(), PurrfectBlocks.OPTIFINE_FLAG.get(),
                    ...
                    PurrfectBlocks.WIZARDS_REBORN_WALL_FLAG.get(), PurrfectBlocks.FLUFFY_FUR_WALL_FLAG.get(), PurrfectBlocks.SILLY_ODDITIES_WALL_FLAG.get(), PurrfectBlocks.OPTIFINE_WALL_FLAG.get())
            .build(null));
