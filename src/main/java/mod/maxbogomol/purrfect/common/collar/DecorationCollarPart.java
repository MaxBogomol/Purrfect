...
public class DecorationCollarPart extends CollarPart {
    @OnlyIn(Dist.CLIENT)
    public BakedModel model;

    public DecorationCollarPart(String id) {
        super(id);
    }
    ...
    public ResourceLocation getTexture() {
        ...
        return new ResourceLocation(modId, "textures/entity/curio/collar/decoration/" + partId + ".png");
    }
